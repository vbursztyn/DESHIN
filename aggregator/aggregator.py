...
DEFAULT_FEATURES = { "base_feature" : similarityToTitle,
					"tuning_features" : [ orderInText, moreFrequentActors, lessFrequentActors ] } # To be moved to elsewhere.


DEFAULT_WEIGHTS = { "base_feature" : 1.0,
					"tuning_features" : [ 0.2, 0.6, 0.3 ] } # To be merged to DEFAULT_FEATURES (as dictionaries).
